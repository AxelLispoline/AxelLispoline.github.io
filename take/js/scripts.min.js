...
$(function(){$(".owl-carousel").owlCarousel({margin:0,autoWidth:!0,responsiveClass:!0,loop:!0,smartSpeed:300,responsive:{0:{items:1},600:{items:3},1e3:{items:5},1400:{items:7}}}),$(".clicker").click(function(){$(".menu").css("top","0"),$(".menu").fadeIn("slow"),$("body").css("overflow-y","hidden")}),$(".exit").click(function(){$(".menu").fadeOut("slow"),$("body").css("overflow-y","visible")}),$(".swap1").click(function(){$(this).removeClass("fa-heart-o"),$(this).addClass("fa-heart"),$(this).css({color:"red",transition:"all .15s ease-in",transform:"scale(1.2)"}),$(".ty1").delay(400).fadeIn("slow")}),$(".swap2").click(function(){$(this).removeClass("fa-heart-o"),$(this).addClass("fa-heart"),$(this).css({color:"red",transition:"all .15s ease-in",transform:"scale(1.2)"}),$(".ty2").delay(400).fadeIn("slow")}),$(".swap3").click(function(){$(this).removeClass("fa-heart-o"),$(this).addClass("fa-heart"),$(this).css({color:"red",transition:"all .15s ease-in",transform:"scale(1.2)"}),$(".ty3").delay(400).fadeIn("slow")}),$(".plan").hover(function(){$(".plan h5").addClass("purple"),$(this).addClass("shadow")},function(){$(".plan h5").removeClass("purple"),$(this).removeClass("shadow")}),$(".plan1").hover(function(){$(".plan1 h5").addClass("purple"),$(this).addClass("shadow")},function(){$(".plan1 h5").removeClass("purple"),$(this).removeClass("shadow")}),$(document).ready(function(){$(".loader_inner").fadeOut(),$(".loader").delay(400).fadeOut("slow")}),$(window).scroll(function(){$(".arrow").css("opacity",1-$(window).scrollTop()/250)}),$(window).scroll(function(){$(this).scrollTop()>50?$("#back-to-top").fadeIn():$("#back-to-top").fadeOut()}),$("#back-to-top").click(function(){return $("body,html").animate({scrollTop:0},800),!1}),$(".menu a").click(function(){$(this).mPageScroll2id({speed:100}),$(".menu").fadeOut(),$("body").css("overflow-y","visible")}),$("form").submit(function(){var s=$(this);return $.ajax({type:"POST",url:"mail.php",data:s.serialize()}).done(function(){alert("Thank you!"),setTimeout(function(){s.trigger("reset")},1e3)}),!1})});