...
$(function(){$(".popup-youtube").magnificPopup({disableOn:700,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!1}),$("#my-menu").mmenu({extensions:["theme-dark","fx-menu-fade","fx-listitems-slide","pagedim-black","listview-justify","border-full"],navbar:{title:'<span class="logo">Wooder</span>'}}),$(".share").click(function(){$(".shareToggle").fadeToggle()}),$("#my-menu").data("mmenu").bind("open:finish",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(window).scroll(function(){$(this).scrollTop()>50?$("#back-to-top").fadeIn():$("#back-to-top").fadeOut()}),$("#back-to-top").click(function(){return $("body,html").animate({scrollTop:0},800),!1}),$(".main_button").hover(function(){$(".v_mean_v").animate({top:"180px",opacity:"0.8",fontSize:"250px",duration:"2000",easing:"easeInExpo"},1e3),$(".rotate_text").animate({right:"450px",opacity:"1.0",fontSize:"20px",duration:"1500",easing:"easeInOut"},800).css({transform:"rotate(0deg)","margin-top":"-15px"})})});